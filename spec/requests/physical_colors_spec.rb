...
#from autogenerated controller spec (by scaffold)
  ...
  describe "GET #index" do
    it "returns a success response" do
      ...
      get url_for(controller: :physical_colors, action: :index)
  ...
  describe "GET #show" do
    it "returns a success response" do
      physical_color = PhysicalColor.create! valid_attributes
      get url_for(controller: :physical_colors, action: :show, id: physical_color.to_param)
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new PhysicalColor" do
        expect {
          post url_for(controller: :physical_colors, action: :create, physical_color: valid_attributes)
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new physical_color" do
        post url_for(controller: :physical_colors, action: :create, physical_color: invalid_attributes)
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested physical_color" do
        physical_color = PhysicalColor.create! valid_attributes
        put url_for(controller: :physical_colors, action: :update, id: physical_color.to_param, physical_color: new_attributes)        
      ...
      it "renders a JSON response with the physical_color" do
        physical_color = PhysicalColor.create! valid_attributes
        put url_for(controller: :physical_colors, action: :update, id: physical_color.to_param, physical_color: valid_attributes)        
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the physical_color" do
        physical_color = PhysicalColor.create! valid_attributes
        put url_for(controller: :physical_colors, action: :update, id: physical_color.to_param, physical_color: invalid_attributes)
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested physical_color" do
      physical_color = PhysicalColor.create! valid_attributes
      expect {
        delete url_for(controller: :physical_colors, action: :destroy, id: physical_color.to_param)
      }.to change(PhysicalColor, :count).by(-1)
    end
  end
